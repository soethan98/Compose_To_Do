...
import com.soethan.todocompose.ui.presentation.components.PriorityDropDown
import com.soethan.todocompose.ui.theme.LARGE_PADDING
import com.soethan.todocompose.ui.theme.MEDIUM_PADDING
...
fun TaskContent(
    ...
    priority: Priority,
    onPrioritySelected: (Priority) -> Unit, modifier: Modifier = Modifier
) {
    Column(
        modifier = modifier
            .fillMaxSize()
